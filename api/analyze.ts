...
{"photos":[{"box_2d":[ymin,xmin,ymax,xmax],"rotation":number,"caption":string|null,"caption_confidence":number,"pose":string,"pose_confidence":number}]}

- box_2d: その生写真1枚が占める範囲。画像全体を0〜1000に正規化した [ymin, xmin, ymax, xmax]
- rotation: その生写真を「正しい向き」（顔が上・下端の印字の文字が水平に読める状態）にするために、時計回りに回転させる角度。0 / 90 / 180 / 270 のいずれか。横倒しなら90か270、上下逆さまなら180。顔の向きと印字の文字の向きの両方で判断すること
